...
TARGETS = [
    ...
    {"key": "fridge", "group": "chilled", "label": "American fridge freezer (plumbed, ice + water)",
     "queries": ["American fridge freezer ice water", "Samsung American fridge freezer ice water", "LG American fridge freezer ice water"],
     "ceiling": 650, "grades": ["A", "B", "C"], "exclude": ["non-plumbed", "non plumbed", "water tank", "tank fill"],
     "flag": "Confirm it's PLUMBED (mains-fed) with ice + water - often not stated in title. Also check A-E energy rating."},
